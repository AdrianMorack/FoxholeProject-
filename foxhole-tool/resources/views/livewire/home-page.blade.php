    ...
    <div class="relative z-10">
            ...
            <div class="container mx-auto px-4 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <!-- Star Icon -->
                        <svg class="w-8 h-8 text-[#ffd700] fill-[#ffd700]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-4xl mx-auto text-center mb-8">
                <div class="inline-block border-4 border-[#4a7c59] bg-[#0f140f] px-6 py-4 mb-6 shadow-xl">
            ...
            <div class="grid md:grid-cols-2 gap-4 max-w-4xl mx-auto">
                ...
                <x-ui.card class="group hover:scale-105 transition-transform duration-300">
                    <x-ui.card-header class="relative">
                        <div class="flex justify-between items-start">
                            <x-ui.card-title class="text-xl py-6">OPERATIONAL STATUS</x-ui.card-title>
                        </div>
                    ...
                    <x-ui.card-content class="flex flex-col items-center py-6">
                        <div class="bg-[#1a4a2a] p-4 rounded-full mb-3 group-hover:bg-[#2a5a3a] transition-colors">
                            <svg class="w-10 h-10 text-[#5a9c69]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                            </svg>
                        </div>
                        <p class="text-center text-sm text-military-text-secondary">
                            Victory Points, War Duration, Casualty Estimates, and more
                        </p>
                    </x-ui.card-content>
                ...
                <x-ui.card class="group hover:scale-105 transition-transform duration-300">
                    <x-ui.card-header class="relative">
                        <div class="flex justify-between items-start">
                            <x-ui.card-title class="text-xl py-6">WAR MAP</x-ui.card-title> 
                        </div>
                        <x-ui.card-description>
                    ...
                    <x-ui.card-content class="flex flex-col items-center py-6">
                        <div class="bg-[#1a3a4a] p-4 rounded-full mb-3 group-hover:bg-[#2a4a5a] transition-colors">
                            <svg class="w-10 h-10 text-[#4a7a9c]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
                        </div>
                        <p class="text-center text-sm text-military-text-secondary">
                            Track territorial control in real time
                        </p>
                    </x-ui.card-content>
                    ...
                    <div class="flex items-center justify-between gap-4">
                        ...
                        @if(isset($stats['last_updated_at']) && $stats['last_updated_at'])
                            <p class="text-xs text-[#8b9d83] whitespace-nowrap">
                                Updated {{ $stats['last_updated_at']->diffForHumans() }}
                            </p>
                        @endif
                    </div>
                </div>
